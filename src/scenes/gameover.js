...
export default function gameover(citySfx) {
  ...
  k.add([
    k.text("FIM DE JOGO", { font: "mania", size: 96 }),
    k.anchor("center"),
    k.pos(k.center().x, k.center().y - 300),
  ]);
  k.add([
    k.text(`MELHOR PONTUAÇÃO : ${bestScore}`, {
      font: "mania",
      size: 64,
    }),
    k.anchor("center"),
  ...
  k.add([
    k.text(`PONTUAÇÃO ATUAL : ${currentScore}`, {
      font: "mania",
      size: 64,
    }),
    k.anchor("center"),
  ...
  k.wait(1, () => {
    k.add([
      k.text("Aperte Espaço/Clique/Toque Para Jogar Novamente", {
        font: "mania",
        size: 64,
      }),
      k.anchor("center"),
